package com.uptoser.java_learning.concurrency.chapter_07_customize_concurrent.chapter_07_03_ThreadFactory_Thread;
...
public class MyThread extends Thread {
    ...
    /**
     * Constructor of the class. Use the constructor of the Thread class and
     * storeas the creation date of the Thread
     * 
     * @param target
     *            Task to execute
     * @param name
    ...
    /**
     * Main method of the thread. Stores the start date and the finish date and
     * calls the run() method of the parent class
     */
    @Override
    public void run() {
        setStartDate();
