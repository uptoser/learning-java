package com.uptoser.java_learning.concurrency.chapter_09.chapter_09_06_semaphore;

import java.util.concurrent.Semaphore;
import java.util.concurrent.TimeUnit;

/**
 * Main class of the example. Create ten threads to execute ten task objects and
 * write information about the semaphore
 *
 */
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Create and launch a thread every 200 milliseconds. After each
         * creation, show information about the semaphore
         */
