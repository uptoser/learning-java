...
/**
 * Main method of the class. It creates an Executor with a PriorityQueue as
 * working queue and then sends various tasks with different priorities to check
...
public class Main {
    ...
    public static void main(String[] args) {
        /*
         * Create an executor with a PriorityBlockingQueue as the structure to
         * store the tasks
         */
