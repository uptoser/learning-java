...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Send to the executor a delayed task. It will be executed after 1
         * second of delay
         */
        ...
        /*
         * Send to the executor a delayed task. It will begin its execution
         * after 1 second of dealy and then it will be executed every three
         * seconds
         */
