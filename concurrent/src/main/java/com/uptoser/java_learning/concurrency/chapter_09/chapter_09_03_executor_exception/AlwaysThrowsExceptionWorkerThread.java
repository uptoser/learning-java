...
/**
 * This class implements a worker thread. This is a thread that is going to
 * execute ForkJoinTask objects in a ForkJoinPool.
 * 
...
public class AlwaysThrowsExceptionWorkerThread extends ForkJoinWorkerThread {
    ...
    /**
     * Method that is going to execute where the Worker Thread begins its
     * execution
     */
    @Override
